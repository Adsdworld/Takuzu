...
/*
 * Les registres sont adressés avec IOCON.BANK = 0 (les adresses se suivent)
 * Les adresses définies ci dessous correspondent en réalité aux adresses des registres du port A.
 ...
 * 			- ...
 * Dans le code, le role du +1 est joué par "+ MCP23S17_PORT_B" dans l'enum MCP23S17_port_e ci dessous
*/
...
typedef enum{
	MCP23S17_IT_ON_CHANGE = 0, //Type de comparaison 1: on déclenche une IT lorsque la valeur du GPIO change
	MCP23S17_IT_ON_REF	  	  //Type de comparaison 2: on déclanche une IT lorsque la valeur du GPIO diffÃ¨re de sa valeur de référence inscrite dans le registre DEFVAL
